About flake8-rst-docstrings-feedstock
=====================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flake8-rst-docstrings-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6863&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flake8-rst-docstrings-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flake8-rst-docstrings` can be installed with `conda`:
...
```
mamba install flake8-rst-docstrings
```

It is possible to list all of the versions of `flake8-rst-docstrings` available on your platform with `conda`:
...
```
mamba search flake8-rst-docstrings --channel conda-forge
```
...
mamba repoquery search flake8-rst-docstrings --channel conda-forge

# List packages depending on `flake8-rst-docstrings`:
mamba repoquery whoneeds flake8-rst-docstrings --channel conda-forge

# List dependencies of `flake8-rst-docstrings`:
mamba repoquery depends flake8-rst-docstrings --channel conda-forge
```
